...
public final class Eons {
    ...
    // ***** Instance Variables
    private EonsControlState mPnnDataState = EonsControlState.INITING;
    private EonsControlState mOplDataState = EonsControlState.INITING;
    private OplRecords mOplRecords;
    private PnnRecords mPnnRecords;
     ...
     */
    public ArrayList<OperatorInfo>
    getEonsForAvailableNetworks(ArrayList<OperatorInfo> avlNetworks) {
