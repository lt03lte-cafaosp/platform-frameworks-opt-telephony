...
public class IccSmsInterfaceManager extends ISms.Stub {
     ...
     *  the current default SMSC
     * @param destPort the port to deliver the message to
     * @param orgPort the orginal port set by sender
     * @param data the body of the message to send
     * @param sentIntent if not NULL this <code>PendingIntent</code> is
     *  broadcast when the message is successfully sent, or failed.
     *  The result code will be <code>Activity.RESULT_OK<code> for success,
     ...
     *  raw pdu of the status report is in the extended data ("pdu").
     */
    public void sendDataWithOrgPort(String callingPackage, String destAddr,
            String scAddr, int destPort, int orgPort, byte[] data,
        ...
        if (Rlog.isLoggable("SMS", Log.VERBOSE)) {
            log("sendData: destAddr=" + destAddr + " scAddr=" + scAddr + " destPort=" +
                destPort + "orgPort=" + orgPort + " data='"+ HexDump.toHexString(data) +
        ...
        ((ImsSMSDispatcher)mDispatcher).sendDataWithOrgPort(destAddr, scAddr, destPort,
          orgPort, data, sentIntent, deliveryIntent);
    }
     ...
     * @param priority Priority level of the message
     */
    public void sendMultipartTextWithPriority(String callingPackage, String destAddr,
        ...
        mDispatcher.sendMultipartTextWithPriority(destAddr, scAddr, (ArrayList<String>) parts,
                (ArrayList<PendingIntent>) sentIntents,
                (ArrayList<PendingIntent>) deliveryIntents, priority);
    }
